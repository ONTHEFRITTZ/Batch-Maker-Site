          ...
          {[
            {
              title: 'Pricing',
              content: null,
              list: ['30-day free trial', '$25 USD per month after trial'],
            },
            {
              title: 'Auto-Renewal',
              content: 'Subscriptions renew automatically unless canceled at least 24 hours before the end of the current period.',
            },
            {
              title: 'Management',
              content: "Billing and cancellations are handled by Apple App Store or Google Play. Manage your subscription in your account settings or through your device's subscription management system.",
            },
            {
              title: 'Free Trial',
              content: "Your free trial is for 30 days. You can cancel at any time during the trial period without being charged. If you don't cancel, your subscription will automatically begin at the end of the trial period.",
            },
            {
              title: 'Cancellation',
              content: "You can cancel your subscription at any time. When you cancel, you'll continue to have access until the end of your current billing period. No refunds are provided for partial periods.",
            },
          ].map((section) => (
